...
We require that you write test code using pytest for each of the above functions along with the implementation of that function. This is a way of demonstrating that you understand what each function is supposed to do. Put your test code in lab07_student_test.py and submit it along with your lab07.py. This test code is worth some amount of points for this lab. We recommend writing at least 3-5 test cases per function, but feel free to write more until you're confident with your solution. 
